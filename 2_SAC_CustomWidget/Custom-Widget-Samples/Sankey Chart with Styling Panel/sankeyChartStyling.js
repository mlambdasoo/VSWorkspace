(function () {
  ...
  class SankeyChartStylingPanel extends HTMLElement {
    constructor() {
      ...
      this._shadowRoot
        .getElementById("depth0_itemColor")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 0));
      this._shadowRoot
        .getElementById("depth0_lineOpacity")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 0));

      this._shadowRoot
        .getElementById("depth1_itemColor")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 1));
      this._shadowRoot
        .getElementById("depth1_lineOpacity")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 1));

      this._shadowRoot
        .getElementById("depth2_itemColor")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 2));
      this._shadowRoot
        .getElementById("depth2_lineOpacity")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 2));

      this._shadowRoot
        .getElementById("depth3_itemColor")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 3));
      this._shadowRoot
        .getElementById("depth3_lineOpacity")
        .addEventListener("change", this.onDepthSettingsChanged.bind(this, 3));
    ...
    disconnectedCallback() {
      console.log(
        `styling[${this._props["widgetName"]}]: disconnectedCallback()`
      );
    }
    ...
    onCustomWidgetBeforeUpdate(changedProps) {
      ...
      console.log(
        `styling[${
          this._props["widgetName"]
        }]: onCustomWidgetBeforeUpdate(${JSON.stringify(changedProps)})`
      );
    }
    ...
    onCustomWidgetDestroy() {
      console.log(
        `styling[${this._props["widgetName"]}]: onCustomWidgetDestroy()`
      );
    }
    ...
    get depth0Opacity() {
      return parseFloat(
        this._shadowRoot.getElementById("depth0_lineOpacity").value
      );
    }
    ...
    get depth1Opacity() {
      return parseFloat(
        this._shadowRoot.getElementById("depth1_lineOpacity").value
      );
    }
    ...
    get depth2Opacity() {
      return parseFloat(
        this._shadowRoot.getElementById("depth2_lineOpacity").value
      );
    }
    ...
    get depth3Opacity() {
      return parseFloat(
        this._shadowRoot.getElementById("depth3_lineOpacity").value
      );
    }
  }
