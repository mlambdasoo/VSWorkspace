(function () {
  ...
  const metricIconMap = {
    ...
    Oregon:
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Location.png",
    "Carbonated Drinks":
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/CarbonatedDrinks.png",
    Juices:
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Juices.png",
    Alcohol:
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Alcohol.png",
    Others:
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Others.png",
    "Gross Margin":
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/GrossMargin.png",
    Discount:
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Discount.png",
    "Original Sales Price":
      "https://fp68static.cfapps.eu10-004.hana.ondemand.com/sap-icons/Price.png",
  ...
  class MetricPlotareaComponent extends HTMLElement {
    ...
    render() {
      ...
      if (this._secondaryRows && Array.isArray(this._secondaryRows)) {
        ...
        this._secondaryRows.forEach((row) =>
          this.renderSecondaryNumber(row.number)
        );
      }
    }
    ...
    renderLabel(label) {
      ...
      labelContainer.setAttribute(
        "style",
        `background-color: ${bgColor}; width: 100%; left: ${x}px; top: ${y}px; font-size: ${fontSize};`
      );
      ...
      iconImg.setAttribute(
        "src",
        metricIconMap[pointValue] || metricIconMap.City || metricIconMap.Info
      );

      if (!this._labelIcon) iconImg.style.display = "none";
    }
    ...
    renderNumber(num) {
      ...
      numContainer.setAttribute(
        "style",
        `width: 100%; left: ${x}px; top: ${y}px; font-size: ${fontSize};`
      );
      if (this._customUnit) {
      ...
      } else numLabelEl.textContent = formattedValue;
     ...
     * @param {*} numContainer
     */
    renderProgressBar(height, pointValue, numContainer) {
      return;
      ...
      const trackHeight = Math.max(height * 0.15, 3);
      const heightStyle = `height: ${trackHeight}px; bottom: ${
        -trackHeight / 2
      }px;`;

      // Set progress track style
      const numberTrackColor = this._numberTrackColor;
      const numberTrackElement = numContainer.querySelector(
        ".metric-progress-track"
      );
      ...
      const numberBarElement = numContainer.querySelector(
        ".metric-progress-bar"
      );
      ...
      const numberBarInnerElement = numContainer.querySelector(
        ".metric-progress-bar-inner"
      );
      const barColor = this._numberBarColor;
      numberBarInnerElement.setAttribute("style", `background: ${barColor};`);
    }
    ...
    renderSecondaryNumber(num) {
      ...
      numContainer.setAttribute(
        "style",
        `background-color: ${bgColor}; width: ${
          width + 50
        }px; left: ${x}px; top: ${y}px; font-size: ${fontSize}; min-height: 16px;`
      );
      if (this._customUnit) {
        let resultValue = (pointValue / this._customUnitNum).toFixed(2);
        resultValue = parseFloat(resultValue);
